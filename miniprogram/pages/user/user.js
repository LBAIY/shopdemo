...
Page({
  ...
  data: {
    ...
    payList: [
      ...
      { id: 1, imgUrl: '../../images/pay/daifukuan.png', title: '待付款', url: '/pages/unpaid/unpaid' },
      { id: 2, imgUrl: '../../images/pay/daishouhuo.png', title: '待收货', url: '/pages/ship/ship'},
      { id: 3, imgUrl: '../../images/pay/daipingjia.png', title: '待评价', url: '/pages/accomplishOrder/accomplishOrder' },
